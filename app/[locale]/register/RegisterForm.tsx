...
export default function RegisterForm({ locale }: { locale: string }) {
  ...
  return (
    <div className="w-full max-w-md fiji:max-w-2xl usa:max-w-3xl china:max-w-4xl lg:max-w-4xl bg-white rounded-3xl cartoon-shadow-pink relative overflow-hidden mt-8">
      ...
      {/* Card Header */}
      <div className="p-6 md:p-8 border-b-3 border-elmore-dark bg-elmore-pink text-white flex justify-between items-center mt-2">
        <div>
        ...
        <div className="md:col-span-5 flex flex-col justify-between">
          ...
          <div className="mt-8 flex flex-col gap-4">
            ...
            <p className="text-center text-sm font-semibold text-slate-500">
              Already enrolled?{' '}
              <Link href={`/${locale}/login`} className="text-elmore-sky hover:underline font-bold">
                Open Locker (Log In)
              </Link>
            </p>
          </div>
